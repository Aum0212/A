        ...
        <div class="row justify-content-center mt-5">
            ...
            <?php while($row = mysqli_fetch_array($result)){  ?>
                    <form method="post" action="admin_edit_db.php"> 
                        <h1 class="text-center mt-3">แก้ไขข้อมูลแอดมิน</h1>
                        ...
                        <input type="text" class="form-control mb-3" name="m_phone" required value="<?php echo $row['m_phone'];?>">
                            ...
                            <input type="submit" name="submit" value="แก้ไขข้อมูลแอดมิน" class="btn btn-primary mt-3 mb-3 w-100 ">
                            <a class = "btn btn-primary mt-3 mb-3 w-100" href="admin.php">ย้อนกลับ</a>
                            </div>
                    </form>
                <?php } ?>
                </div>
