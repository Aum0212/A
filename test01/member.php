                    ...
                    <table class="table tabel-hover table-bordered text-center">
                            ...
                            <tr>
                                ...
                                <td class="d-flex gap-2">
                                    <a class ="btn btn-dark text-white w-50" href="member_edit.php?id=<?php echo $row['t_id'];?>" > <i class="bi bi-pencil-square"></i> แก้ไข</a>
                                    <a onclick="return confirm('คุณต้องการลบผู้ใช้งานใช่หรือไม่ ?'); "class ="btn btn-dark w-50" href="member_delete.php?id=<?php echo $row['t_id'];?>"> <i class="bi bi-trash"></i> ลบ</a>
                                </td>
                            </tr>
                            <?php } ?>
