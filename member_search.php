...
<body>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item">
            <a class="nav-link" href="borrow_return">จัดการการยืม-คืน</a>
            </li>
        </ul>
                    ...
                    <table class="table tabel-hover table-bordered text-center">
                            ...
                            <tr>
                                ...
                                <td class="d-flex gap-2">
                                    <a class ="btn btn-dark text-white w-50" href="member_edit.php?id=<?php echo $row['m_id'];?>">แก้ไข</a>
                                    <a onclick="return confirm('คุณต้องการลบผู้ใช้งานใช่หรือไม่ ?'); "class ="btn btn-dark w-50" href="member-delete.php?id=<?php echo $row['m_id'];?>">ลบ</a>
                                </td>
                            </tr>
                            <?php } ?>
                            <?php } ?>
