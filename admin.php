...
<body>
        ...
        <span class="navbar-toggler-icon"></span>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                    <a class="nav-link active" href="admin">จัดการข้อมูลผู้ดูแลระบบ</a>
                    </li>
                    <li class="nav-item">
    ...
    <!-- ส่วนของ tabel -->
        <div calss="containar">
            <div class="row">
                <div class="col-md-12">
                <h1 class=" mt-5">ตารางข้อมูลผู้ดูแลระบบ</h1>
                </div>
                ...
                <table class="table tabel-hover table-bordered text-center">
                        ...
                        <tr>
                            ...
                            <td class="d-flex gap-2">
                                <a class ="btn btn-dark text-white w-100" href="admin_edit.php?id=<?php echo $row['m_id'];?>"> <i class="bi bi-pencil-square"> </i>แก้ไข</a>
                            </td>
                        </tr>
                        <?php } ?>
